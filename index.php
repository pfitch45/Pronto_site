...
<html lang="en">
  ...
  <body>
      ...
      <div class="jumbotron">
        ...
        <p class="lead">Specializing in furniture assembly and installation in the San Francisco Bay Area.<br> Se habla espa&#241ol.</p>
    </div>

      <!--<div class="row marketing">
        <div class="col-lg-6">
          <h4>Installation Solutions</h4>
          <p>We install TV mounts, whiteboards, picture frames, shelves, and pretty much anything around your home or office space. Pronto also has many years of collective experience working in and around Bay Area office environments.</p>

          <h4>Same Day Service</h4>
          <p>Whenever possible, we try to accomodate our customers with same-day service. And our scheduling is famous for its flexibility!</p>
        </div>

        <div class="col-lg-6">
          <h4>The Bay Area RTA Specialists</h4>
          <p>"Ready-To-Assemble" furniture: <br> We are very familiar with RTA furniture sold at major retailers including Ikea, West Elm, Staples, Sauder, Coaster, Overstock.com, CB2, Crate and Barrel, South Shore, The Container Store, Bush, Office Max, Easy Closet, Target, Walmart, Office Depot, just to name a few.</p>

          <h4>Pricing</h4>
          <p>All In One offers flat, competitve rates for jobs. The minimum service fee is $59.99.

To get specific pricing information, please <a href="form.php">contact us</a> or call us at 510-772-7152. We can go over your individual needs and how to best meet them.</p>
        </div>
      </div>-->
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="item">
          <img src="http://placehold.it/1024x700" alt="First slide">
          <div class="container">
